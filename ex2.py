...
def term_work_mark(a0,a1,a2,exercises,quiz,term_test):
    '''(float,float,float,float,float,float)->float
        returns term work
        REQ: (a0,a1,a2,exercises,quiz,term_test)>=0
...
def final_mark(a0,a1,a2,exercises,quiz,term_test,final_exam):
    '''(float,float,float,float,float,float,float)->float
        returns final mark im
        REQ:(a0,a1,a2,exercises,quiz.term_test,final_exam)>=0
...
def is_pass(a0,a1,a2,exercises,quiz,term_test,final_exam):
    '''(float,float,float,float,float,float,float)->bool
       ...
       REQ: final_mark>=40.0, term_mark>=40.0
    ...
    final_overall_mark=(final_mark(a0,a1,a2,exercises,quiz,term_test,final_exam)>=50.0) 
    
    #final exam mark must be greater than 40
    final_exam_mark= (final_exam>=40.0)
